...
use App;
use Session;
class uservictim extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        foreach ($complaints as $complaintsus) {
            ...
            $data = casevictim::where('complaint_id', $complaintsusid)->get();
...
// echo'<pre>';
        ...
        $city = city::all();
        return view("frontend.Userblade.CaseVictim", compact('city', 'countries', 'districss', 'states', 'complaints'));
    ...
    {
               return view("frontend.Userblade.ComplaintVictim");
