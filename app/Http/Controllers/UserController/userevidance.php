...
use App;
use Session;
class userevidance extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        foreach ($complaints as $complaintsus) {
            ...
            $data = caseevidance::where('complaint_id', $complaintsusid)->get();
        ...
        $city = city::all();
        return view("frontend.Userblade.Casesevidance", compact('city', 'countries', 'districss', 'states', 'complaints'));
    ...
    public function store(Request $request)
    {
        ...
        return view("frontend.Userblade.Casesevidance");
