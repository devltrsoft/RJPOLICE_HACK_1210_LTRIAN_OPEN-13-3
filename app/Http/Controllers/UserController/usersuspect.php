...
use App;
use Session;
class usersuspect extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        foreach ($complaints as $complaintsus) {
            ...
            $data = casesuspect::where('complaint_id', $complaintsusid)->get();
...
// echo'<pre>';
        ...
        $city = city::all();
        return view("frontend.Userblade.Case-Suspect", compact('city', 'countries', 'districss', 'states', 'complaints'));
