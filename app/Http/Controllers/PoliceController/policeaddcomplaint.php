...
class policeaddcomplaint extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $city = city::all();
        return view("frontend.Policeblade.Addcomplaint", compact('data', 'complaintstypes', 'complaintfir', 'statuss', 'UserDetail', 'city', 'countries', 'districss', 'states', ));
    }
