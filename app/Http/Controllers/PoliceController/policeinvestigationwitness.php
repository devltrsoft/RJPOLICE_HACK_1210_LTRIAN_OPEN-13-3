...
class policeinvestigationwitness extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        foreach ($complaints as $complaintsus) {
            ...
            foreach ($data as $complaint) {
                ...
                $suspect = investigationwitness::where('fir_id', $fir_id)->get();
        ...
        return view("frontend.Policeblade.Investi-witness",compact('complaints','city', 'countries', 'districss', 'states',));
