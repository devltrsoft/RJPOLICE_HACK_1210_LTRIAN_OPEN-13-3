...
use App\Models\investicationvictim;
use App\Models\city;
...
class policeinvestigationvictim extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        foreach ($complaints as $complaintsus) {
            ...
            foreach ($data as $complaint) {
                ...
                $suspect = investicationvictim::where('fir_id', $fir_id)->get();
        ...
        return view("frontend.Policeblade.investigationVictim",compact('complaints','city', 'countries', 'districss', 'states',));
