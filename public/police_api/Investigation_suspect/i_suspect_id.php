...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $investigation_suspect_id=$_POST['investigation_suspect_id'];

$sql = "SELECT * FROM investigation c
        
        INNER JOIN investigation_suspect u ON u.fir_id = c.fir_id
        ...
        Where u.investigation_suspect_id='$investigation_suspect_id'
        ";
