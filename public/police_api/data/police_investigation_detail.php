<?php
//used to display all Investigation detail to police based on police_id
...
$police_id="2";
$sql = "SELECT * 
        FROM  investigation i, complaint c, investigation_witness iw, police_station ps, investigation_suspect iis, victim v, evidance e, evidance_photos ep, ";
