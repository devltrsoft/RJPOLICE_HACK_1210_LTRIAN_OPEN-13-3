...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $investigation_witness_id=$_POST['investigation_witness_id'];

$sql = "SELECT * FROM investigation c
        
        INNER JOIN investigation_witness u ON u.fir_id = c.fir_id
        ...
        Where u.investigation_witness_id='$investigation_witness_id'
        ";
