...
$sql="INSERT INTO `victim`(`fir_id`, `country_id`, `state_id`, `district_id`, `city_id`, `victim_fname`, `victim_mname`, `victim_lname`, `victim_address`, `victim_dob`, `victim_gender`, `victim_mobile_no`, `victim_email`,  `victim_adhar`, `victim_photo`,`victim_pan`, `victim`) VALUES ('$fir','$country_id', '$state_id', '$dist_id','$city_id','$fname','$mname','$lname','$address', '$dob','$gender','$mobile','$email','$adhar','$photo','$victim_pan', '$investigation_victim_desc')";
//echo $sql;
//echo "link=".$link;
...
$description = "one victim is added that is ".$fname." ".$lname;
