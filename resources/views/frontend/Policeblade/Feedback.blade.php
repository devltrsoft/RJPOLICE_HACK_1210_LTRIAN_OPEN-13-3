                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="container d-flex mt-5">
                        <div class="card1 text-center mb-5">
                            ...
                            <span class="name mb-1 fw-500">{{ GoogleTranslate::trans('overall_satisfaction', \App::getLocale()) }}</span>
                            <div class="rate bg-success py-3 text-white mt-3">
                                <h6 class="mb-0">{{ GoogleTranslate::trans('Rate your it', \App::getLocale()) }}</h6>                                <form action="{{ url('/policefeedback') }}" method="post">
                                    @csrf
                                    <div class="rating">
                                    ...
                                    <div class="buttons px-4 mt-0">
                                        <button type="submit"  class="btn btn-warning btn-block rating-submit">{{ GoogleTranslate::trans('Submit', \App::getLocale()) }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="container d-flex mt-5">
                        <div class="card1 text-center mb-5">
                            ...
                            <span class="name mb-1 fw-500">{{ GoogleTranslate::trans('usability_navigation', \App::getLocale()) }}</span>
                            <div class="rate bg-success py-3 text-white mt-3">
                                <h6 class="mb-0">{{ GoogleTranslate::trans('Rate your it', \App::getLocale()) }}</h6>                                <form action="{{ url('/policefeedback') }}" method="post">
                                    @csrf
                                    <div class="rating">
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="container d-flex mt-5">
                        <div class="card1 text-center mb-5">
                            ...
                            <span class="name mb-1 fw-500">{{ GoogleTranslate::trans('training_support', \App::getLocale()) }}</span>
                            <div class="rate bg-success py-3 text-white mt-3">
                                <h6 class="mb-0">{{ GoogleTranslate::trans('Rate your it', \App::getLocale()) }}</h6>                                <form action="{{ url('/policefeedback') }}" method="post">
                                    @csrf
                                    <div class="rating">
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="container d-flex mt-5">
                        <div class="card1 text-center mb-5">
                            ...
                            <span class="name mb-1 fw-500">{{ GoogleTranslate::trans('alert_notification', \App::getLocale()) }}</span>
                            <div class="rate bg-success py-3 text-white mt-3">
                                <h6 class="mb-0">{{ GoogleTranslate::trans('Rate your it', \App::getLocale()) }}</h6>                                <form action="{{ url('/policefeedback') }}" method="post">
                                    @csrf
                                    <div class="rating">
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="container d-flex mt-5">
                        <div class="card1 text-center mb-5">
                            ...
                            <span class="name mb-1 fw-500">{{ GoogleTranslate::trans('security_privacy', \App::getLocale()) }}</span>
                            <div class="rate bg-success py-3 text-white mt-3">
                                <h6 class="mb-0">{{ GoogleTranslate::trans('Rate your it', \App::getLocale()) }}</h6>                                <form action="{{ url('/policefeedback') }}" method="post">
                                    @csrf
                                    <div class="rating">
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="container d-flex mt-5">
                        <div class="card1 text-center mb-5">
                            ...
                            <span class="name mb-1 fw-500">{{ GoogleTranslate::trans('relevance_info', \App::getLocale()) }}</span>
                            <div class="rate bg-success py-3 text-white mt-3">
                                <h6 class="mb-0">{{ GoogleTranslate::trans('Rate your it', \App::getLocale()) }}</h6>
                                <form action="{{ url('/policefeedback') }}" method="post">
                                    @csrf
                                    <div class="rating">
