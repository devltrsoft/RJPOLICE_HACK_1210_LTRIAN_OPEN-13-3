                                ...
                                @foreach ($item->suspect as $suspect)
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="card info-card sales-card" data-bs-toggle="modal"
                                            data-bs-target="#fullscreenShowModal{{ $item->investigation_witness_id }}">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ps-3">
                                                        <h4>{{ GoogleTranslate::trans($suspect->investigation_witness_fname . ' ' . $suspect->investigation_witness_lname, \App::getLocale()) }}
                                                        </h4>

                                                        {{-- <h6>{{ $suspect->investigation_witness_fname }} {{ $suspect->investigation_witness_lname }}</h6> --}}
                                    ...
                                    <div class="modal fade" id="fullscreenShowModal{{ $item->investigation_witness_id }}"
                                        tabindex="-1">
    ...
    <div class="modal fade" id="addModel" tabindex="-1">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/investiwitness') }}" method="post" enctype="multipart/form-data">
                        @csrf
