                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="{{ url('/login') }}" class="d-flex align-items-center w-auto">
                                    <img src="{{ asset('assets/img/rajasthan_police.png') }}" alt=""
            ...
            <div class="modal fade" id="PoliceModel" tabindex="-1">
                <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('/policeindex') }}" method="post">
                                @csrf
                                ...
                                {{-- <div class="form-group">
                                    <label for="country" class="form-label">station_id</label>
                                    <select class="form-select" id="country" name="station_id">
                                        @foreach ($policestation as $policestationItem)
                                            <option value="{{ $policestationItem->police_station_id }}">
                                                {{ $policestationItem->police_station_name }}</option>
                                        @endforeach
                                    </select>
                                </div> --}}
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <select class="form-select" id="country" name="position_id">
                                        @foreach ($policePositions as $policepositionItem)
                                            <option value="{{ $policepositionItem->position_id }}">
                                                {{ $policepositionItem->position_name }}</option>
                                        @endforeach
                                    </select>
                                </div> --}}
                        </div>
            ...
            <div class="modal fade" id="StationInchargeModel" tabindex="-1">
                <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('/stationinchargerindex') }}" method="post">
                                @csrf
                                <div>
                                    <div class="form-group" style="display: inline-block; margin-right: 10px;">
                                        <label for="complaint_against">First Name</label>
                                ...
                                {{-- <div class="form-group">
                                    <label for="country" class="form-label">Police Station</label>
                                    <select class="form-select" id="country" name="position_id">
                                        @foreach ($policePositions as $policepositionItem)
                                            <option value="{{ $policepositionItem->position_id }}">
                                                {{ $policepositionItem->position_name }}</option>
