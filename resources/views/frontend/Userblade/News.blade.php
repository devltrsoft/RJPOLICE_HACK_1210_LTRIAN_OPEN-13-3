                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <h5 class="card-title"> {{ GoogleTranslate::trans( $item->news_title , \App::getLocale()) }}</h5>
                                    </div>
                                </div>
                                ...
                                <div class="card ">
                                    ...
                                    @endif
                                        ...
                                        <p class="card-text"> {{ GoogleTranslate::trans( $item->news_description, \App::getLocale()) }}</p>
                                    </div>
                                </div>
                            </div>
