    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="row">
                ...
                <div class="col-xxl-4 col-md-6">
                    ...
                    {{-- {{ $item->complaint_id }}">                        --}}
                     <div class="filter">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Cmp ID: {{ $complaint['cmp_id'] }}</h5>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6> {{ GoogleTranslate::trans( $complaint['complaint_subject'] , \App::getLocale()) }}</h6>
                ...
                {{-- {{ $item->complaint_id }}" tabindex="-1"> --}}
                    <div class="modal-dialog modal-fullscreen" >
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"> {{ GoogleTranslate::trans('Show Complaint', \App::getLocale()) }}</h5>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary"> <i
                                        class="bx bxs-download"></i> {{ GoogleTranslate::trans(' Download', \App::getLocale()) }}</button>
                            </div>
                        </div>
                    </div>
                </div>
