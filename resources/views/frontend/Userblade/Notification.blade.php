            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-md-6">
                    ...
                    data-bs-target="#fullscreenShowModal{{ $item->notification_id  }}">    
                        ...
                        <div class="card-body">
                            <h5 class="card-title"> {{ GoogleTranslate::trans( $item->notification_title , \App::getLocale()) }}</h5>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6> {{ GoogleTranslate::trans($item->notification_description, \App::getLocale()) }}</h6>
                    ...
                    <div class="modal-dialog modal-fullscreen" >
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"> {{ GoogleTranslate::trans('Show Notification', \App::getLocale()) }}</h5>
