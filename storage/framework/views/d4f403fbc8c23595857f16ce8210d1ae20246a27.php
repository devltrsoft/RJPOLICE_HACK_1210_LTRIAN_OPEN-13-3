                            ...
                            <?php $__currentLoopData = $item->suspect; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suspect): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-xxl-4 col-md-6">
                                    <div class="card info-card sales-card" data-bs-toggle="modal"
                                        data-bs-target="#fullscreenShowModal<?php echo e($item->investigation_suspect_id); ?>">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ps-3">
                                                    <h6><?php echo e(GoogleTranslate::trans($suspect->suspect_fname, \App::getLocale())); ?>
                                ...
                                <div class="modal fade" id="fullscreenShowModal<?php echo e($item->investigation_suspect_id); ?>"
                                    tabindex="-1">
    ...
    <div class="modal fade" id="addmodel" tabindex="-1">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(url('/investisuspect')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltrproin/public_html/rj.ltr-soft.com/resources/views/frontend/Policeblade/Investi-Suspect.blade.php ENDPATH**/ ?>