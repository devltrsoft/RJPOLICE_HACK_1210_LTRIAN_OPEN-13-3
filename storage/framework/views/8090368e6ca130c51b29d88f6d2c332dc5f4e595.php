                    ...
                    <?php $__currentLoopData = $complaintitem->data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card" data-bs-toggle="modal"
                                ...
                                data-bs-target="#editModel<?php echo e($item->complaint_suspect_id); ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6><?php echo e($item->complaint_suspect_fname); ?> <?php echo e($item->complaint_suspect_lname); ?>
                        ...
                        <div class="modal fade" id="editModel<?php echo e($item->complaint_suspect_id); ?>" tabindex="-1">
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo e(route('casesuspect.update', $item->complaint_suspect_id)); ?>"
                                            ...
                                            <div class="form-group">
                                                <label for="fname" class="form-label">First
                                                    Name</label>
                                                <input type="text" class="form-control" name="complaint_suspect_fname"
                                                    value="<?php echo e($item->complaint_suspect_fname); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="mname" class="form-label">Middle
                                                    Name</label>
                                                <input type="text" class="form-control" name="complaint_suspect_mname"
                                                    value="<?php echo e($item->complaint_suspect_mname); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="lname" class="form-label">Last
                                                    Name</label>
                                                <input type="text" class="form-control" id="lname"
                                                    name="complaint_suspect_lname"
                                                    value="<?php echo e($item->complaint_suspect_lname); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="address" class="form-label">Address</label>
                                                <input type="text" class="form-control" id="address"
                                                    name="complaint_suspect_address"
                                                    value="<?php echo e($item->complaint_suspect_address); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="dob" class="form-label">Date of
                                                    Birth</label>
                                                <input type="date" class="form-control" id="dob"
                                                    name="complaint_suspect_dob"
                                                    value="<?php echo e($item->complaint_suspect_dob); ?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control" id="mobile"
                                                    name="complaint_suspect_mobile_no"
                                                    value="<?php echo e($item->complaint_suspect_mobile_no); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="email" class="form-label">Email</label>
                                                <input type="email" class="form-control" id="email"
                                                    name="complaint_suspect_email"
                                                    value="<?php echo e($item->complaint_suspect_email); ?>">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <?php if($item->complaint_suspect_photo_path): ?>
                                                    <img src="<?php echo e(asset('police_api/inputfiles/' . $item->complaint_suspect_photo_path)); ?>"
                                                        alt="Suspect Photo" style="max-width: 100px; margin-top: 10px;">
                                                <?php endif; ?>
                                            </div>
                                            <div class="form-group">
                                                <label for="email" class="form-label">complaint_suspect_adhar</label>
                                                <input type="text" class="form-control" id="email"
                                                    name="complaint_suspect_adhar"
                                                    value="<?php echo e($item->complaint_suspect_adhar); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="email" class="form-label">complaint_suspect_pan</label>
                                                <input type="text" class="form-control" id="email"
                                                    name="complaint_suspect_pan"
                                                    value="<?php echo e($item->complaint_suspect_pan); ?>">
                                            </div>
                                            <div class="form-group">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltrproin/public_html/rj.ltr-soft.com/resources/views/frontend/Userblade/Case-Suspect.blade.php ENDPATH**/ ?>